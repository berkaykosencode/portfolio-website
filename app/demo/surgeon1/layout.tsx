import Navigation from "@/components/surgeon1/Navigation";
import Footer from "@/components/surgeon1/Footer";
import { FaWhatsapp } from "react-icons/fa";

export default function Surgeon1Layout({
    children,
}: {
    children: React.ReactNode;
}) {
    return (
        <div className="bg-[#f8f9fa] min-h-screen font-sans text-slate-800 selection:bg-[#c3a35a] selection:text-white">
            <Navigation />
